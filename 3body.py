...
r1 = CelestialObject(10,Vector(0,0),Vector(0,0.1))
r2 = CelestialObject(10,Vector(5,0),Vector(0.1,0))
r3 = CelestialObject(10,Vector(5,4),Vector(0,0.05))
...
ani = FuncAnimation(fig,animate,frames = range(100), interval = 25)
plt.show()
